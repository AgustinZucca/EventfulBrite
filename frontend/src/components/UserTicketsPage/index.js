...
const UserTicketsPage = () => {
  ...
  const refundTicket = (e, ticketId) => {
    dispatch(ticketActions.deleteTicket(sessionUser.id, ticketId)).then(() => dispatch(ticketActions.loadTickets(sessionUser.id)))
